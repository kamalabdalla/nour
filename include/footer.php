        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Matemwe, Zanzibar, Tz</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+255 676 165 933</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="transfer.php">Our Services</a>
                    <!-- <a class="btn btn-link" href="">Terms & Condition</a> -->
                    <a class="btn btn-link" href="transfer.php">Support</a>
                </div>
                <div class="col-lg-3 col-md-6">
                    <h4 class="text-white mb-4">Services Hours</h4>
                    <p class="mb-1">24 / 7</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>Subscribe to get all updates here</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="fw-medium text-light" href="#">Nour ZanTravel</a>, All Right Reserved.
                </div>
                <div class="col-md-6 text-center text-md-end">
                    Developed By <a class="fw-medium text-light" href="">Mr 'A </a>
                </div>
            </div>
        </div>
    </div>
