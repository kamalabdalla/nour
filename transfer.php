...
?> 
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-2 text-white mb-4 animated slideInDown">Transfer</h1>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <p class="fs-5 fw-medium text-primary">Get Our Expert Services</p>
                    ...
                    <a class="d-inline-flex align-items-center rounded overflow-hidden border border-primary" href="">
                        ...
                        <span class="fs-5 fw-medium mx-4">+255 676 165 933</span>
                    </a>
                    <br>
                    <br>
                    <a class="d-inline-flex align-items-center rounded overflow-hidden border border-primary" href="">
                        ...
                        <span class="fs-5 fw-medium mx-4">+255 623 616 130</span>
                    </a>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <h2 class="mb-4">Please Feel Free</h2>
                    <div class="row g-3">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-floating">
                                <select class="form-select" id="service">
                                    ...
                                    <option value="">From Ferry</option>
                                </select>
                                <label for="service">Choose</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
